...
if (feedback)&(par_smoothing_box != 'auto'):
    ...
    plt.plot(grid, spectre, color='b',alpha=0.4)
    plt.xlabel(r'Wavelength [$\AA$]',fontsize=14)
    plt.ylabel('Flux [a.u]',fontsize=14)
    l1, = plt.plot(grid, ras.smooth(spectre,int(par_smoothing_box),shape = par_smoothing_kernel), color='k')
    axcolor = 'whitesmoke'
...
if (par_Rmax!=par_R)|(par_Rmax=='auto'):
    ...
    if feedback:
        ...
        plt.plot(grid, continuum_small_win,color='r',zorder=3,lw=2)
        plt.plot(grid, continuum_large_win,color='k',zorder=4,lw=3)
        plt.scatter(wave,flux,color='blue',s=1,zorder=2)
        plt.xlabel(r'Wavelength [$\AA$]',fontsize=13) ; plt.ylabel('Flux [a.u]',fontsize=13) ; ax = plt.gca()  
        plt.tick_params(direction='in',top=True,right=True)
        
        plt.subplot(3,2,3,sharex=ax)
        plt.plot(grid, penalite0,color='k',alpha=0.5)
        plt.plot(grid, penalite_step, color='k', lw=2)
        ...
        plt.subplot(2,2,2)
        plt.title('Selection of the penalty-radius law')
...
while loop == 'y':
    ...
    if feedback:
        ...
        plt.plot(grid, continuum)
        plt.scatter(wave,flux,color='k')
        plt.title('Visualisation of intermediate continuum')
...
if feedback:
    ...
    plt.subplot(2,1,1)
    plt.title('Edges cutting step')
    plt.plot(grid, spectre)
    l1, = plt.plot(wave, flux, ls='',color='k',marker='o')
    plt.xlabel(r'Wavelength [$\AA$]',fontsize=14)
    plt.ylabel('Flux [a.u]',fontsize=14)
...
if feedback:
    ...
    plt.subplot(2,1,1)
    plt.plot(grid, spectre)
    plt.title('Anomalous maxima suppression step')
    plt.xlabel(r'Wavelength [$\AA$]',fontsize=14)
    plt.ylabel('Flux [a.u]',fontsize=14)
    
    l1, = plt.plot(wave, flux, ls='',marker='o',color='k')
...
if feedback:
    ...
    plt.plot(grid, spectre, alpha=0.6)
    plt.scatter(locmaxx,locmaxy,color='b',s=5,zorder=3)
    ...
    plt.title('Manual maxima suppression/adjunction')
    l1, = plt.plot(grid, continuum3, color='k',zorder=5)
    l2, = plt.plot(wave,flux,'ko',label='anchor_points (%s)'%(int(len(wave))),zorder=4)
    plt.xlabel(r'Wavelength [$\AA$]',fontsize=14)
    plt.ylabel('Flux [a.u]',fontsize=14)
    plt.show(block=False)
...
if (feedback)|(plot_end)|(save_last_plot):
    ...
    plt.plot(grid[::jump_point], spectre[::jump_point]*normalisation, label = 'spectrum_reduced',color='b',alpha=0.3)
    plt.scatter(wave, flux, color = 'k', label='anchor_points (%s)'%(int(len(wave))),zorder=100)
